...
let currentPlayer=String.fromCodePoint(0x1F467);//initial player i.e., X
...
//part 5 --- X-->O-->X-->O
function handlePlayerChange(){
    currentPlayer=currentPlayer===String.fromCodePoint(0x1F467)?String.fromCodePoint(0x1F466):String.fromCodePoint(0x1F467);
    statusDisplay.innerHTML=currentPlayerTurn();
}
//part-6 ---> restart game
function handleRestartGame(){
    gameActive=true;
    currentPlayer=String.fromCodePoint(0x1F467);
    gameState=["","","","","","","","",""];
    statusDisplay.innerHTML=currentPlayerTurn();
